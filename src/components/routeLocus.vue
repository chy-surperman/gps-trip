          ...
          <el-collapse-item title="查询面版">
            <el-form  class="query-form-box" ref="form" :model="queryForm" label-width="80px">
                ...
                <el-form-item label="线路">
                    <el-col :span="20">
                        <el-select @change="routeChange" v-model="queryForm.routeName" size="medium" placeholder="请选择线路">
                ...
                <el-form-item label="方向">
                    <el-col :span="20">
                        <el-select @change="starttagChange" v-model="queryForm.starttag" size="medium" placeholder="请选择线路">
                ...
                <el-form-item label="车牌号">
                    <el-col :span="20">
                        <el-select v-model="queryForm.locusId" size="medium" placeholder="请选择线路">
                            <el-option v-for="vehicle in vehicles" :key="vehicle.value" 
                                    :label="vehicle.label" :value="vehicle.value">
                            </el-option>
                        </el-select>
                    </el-col>
                </el-form-item>
...
<script>
  import {getMetaRoutenames,getMetadatas,getLocusMetaGpsTemplate} from '@/api/gpsApi'
    ...
    methods:{
      ...
      _getGpsVehicles(){
        let param = {
          ...
          starttag:this.queryForm.starttag
        }
        getMetadatas(param).then(resp => {
          if(resp.code == REQ_SUCCESS){
      ...
      createVehicleInfoWindow(gps){
        let time = document.createElement("div");
            ...
            const timeStr = gps.createTime.split(" ");
      ...
      query(){
        ...
        // getGpsTrack
        // getGpsTrack
        getLocusMetaGpsTemplate(this.queryForm).then(resp => {
